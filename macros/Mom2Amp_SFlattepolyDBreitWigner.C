...
void Mom2Amp_SFlattepolyDBreitWigner(int seed=0){
    ...
    paramManager.SetInitialValue("MD_a_0_0_a0_980_g_KK", 0.0, true);
    paramManager.SetInitialValue("MD_b_0_0_a0_980_g_etapi", 0.353, false);
    paramManager.SetInitialValue("MD_b_0_0_a0_980_g_KK", 0.0, true);
    ...
    paramManager.SetParameterLimits("MD_a_0_0_a0_980_m_expansion", 0.98, 1.5);
    paramManager.SetParameterLimits("MD_b_0_0_a0_980_m_expansion", 0.98, 1.5);
    ...
    fitter.MakeResultTree(paramManager, "result_SFlattepolyO2DBreitWigner_0.root");
